...
public class PetitionStaffChooseZJLXActivity extends PetitionStaffBaseActivity implements View.OnClickListener {
    ...
    private void GetZJLX(String lx,String fjdm) {
        ...
        Subscription subscription = PetitionStaffApiService.Factory.create().getZJLX(GsonUtil.toJson(tlxfjdm))
                ...
                .subscribe(Utils.mockSubscriber(this, Mock.PETITION_LOGIN,
                        new TypeToken<APIResult<List<RDMIDMC>>>() {
                            ...
                            public void onNext(APIResult<List<RDMIDMC>> listAPIResult) {
                                ...
                                mAdapter=new ZJLXAdapter(data,PetitionStaffChooseZJLXActivity.this);
                                ...
                                mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        editor.putString(getString(R.string.petition_staff_sp_ZJLX),data.get(position).getMC());
                                        editor.putString(getString(R.string.petition_staff_sp_ZJLXID),data.get(position).getDM());
                                        editor.commit();
                                        PetitionStaffChooseZJLXActivity.this.finish();
                                    }
                                });
                            }
