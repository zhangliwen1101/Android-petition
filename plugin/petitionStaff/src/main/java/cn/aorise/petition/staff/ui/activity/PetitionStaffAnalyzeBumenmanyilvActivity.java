...
public class PetitionStaffAnalyzeBumenmanyilvActivity extends PetitionStaffBaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        // barChart.invalidate();
        mBinding.txtTitle.setText("责任单位满意率");
    ...
    private void GetAnalyze(String dataStart, String dataEnd, String type,String xingshi,String ZeRenDanWei) {
        ...
        Subscription subscription = PetitionStaffApiService.Factory.create().GetBumenmanyiLv(GsonUtil.toJson(t))
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(Utils.mockSubscriber(this, Mock.PETITION_LOGIN,
                        new TypeToken<APIResult<RAnalyze>>() {
                            ...
                            public void onNext(APIResult<List<Float>> rAnalyzeAPIResult) {
                                ...
                                try {
                                    ...
                                    MpChartAndroidUtil.showBarChart1(PetitionStaffAnalyzeBumenmanyilvActivity.this, mBinding.barchart, barData);
                                } catch (Exception e) {
