...
public class PetitionStaffImportantMonitorAddMatterWTTypeActivity extends PetitionStaffBaseActivity implements View.OnClickListener {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (list.get(position).getChildren().size()==0) {
                    editor.putString(getString(R.string.petition_staff_sp_JYLXY),list.get(position).getMC());
                    editor.putString(getString(R.string.petition_staff_sp_JYLXYDM),list.get(position).getDM());
                    editor.putString(getString(R.string.petition_staff_JYLXE),"");
                    editor.putString(getString(R.string.petition_staff_JYLXEDM),"");
                    editor.putString(getString(R.string.petition_staff_JYLXS),"");
                    editor.putString(getString(R.string.petition_staff_JYLXSDM),"");
                    editor.commit();
                    PetitionStaffImportantMonitorAddMatterWTTypeActivity.this.finish();
                } else {
                    Intent intent = new Intent(PetitionStaffImportantMonitorAddMatterWTTypeActivity.this, PetitionStaffImportantMonitorAddMatterWTTypeActivity01.class);
