...
public class QueryEvaluateAdjunctAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView!=null){
            ...
            view= View.inflate(mContext, R.layout.petition_staff_add_adjunct_picture_item,null);
            holder=new Holder();
            ...
            //原先的正常数据的显示，操作等
            AoriseUtil.loadImage(mContext,holder.tupian, Utils.url+mydata);
        System.out.println(Utils.url+mydata);
