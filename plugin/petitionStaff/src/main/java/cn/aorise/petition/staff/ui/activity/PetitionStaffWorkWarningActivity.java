...
public class PetitionStaffWorkWarningActivity extends PetitionStaffBaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (R.id.rl_petition_return==id) {
            PetitionStaffWorkWarningActivity.this.finish();
    ...
    protected void initView() {
        ...
        mBinding.txtTitle.setText(getString(R.string.petition_staff_work_warning_01));
                ...
                if(keyCode==KeyEvent.KEYCODE_ENTER){//修改回车键功能
                    ...
                    ((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE))
                            .hideSoftInputFromWindow(
                                    PetitionStaffWorkWarningActivity.this
                                            .getCurrentFocus()
                                            .getWindowToken(),
    ...
    private void GetWorkWarningList(int currentPage, int pageSize, final String ly, String zzjg, String zt, final String condition) {
        ...
        Subscription subscription = PetitionStaffApiService.Factory.create().GetWorkWarningList(GsonUtil.toJson(tWorkWarningListt))
                ...
                .subscribe(Utils.mockSubscriber(this, Mock.PETITION_LOGIN,
                        new TypeToken<APIResult<List<RWorkWarningList>>>() {
                            ...
                            public void onNext(APIResult<List<RWorkWarningList>> listAPIResult) {
                                data.clear();
                                //System.out.println(listAPIResult.getData().get(1).toString());
                                ...
                                mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        Intent intent=new Intent(PetitionStaffWorkWarningActivity.this,PetitionStaffWorkWarningDetailActivity.class);
