...
public class PetitionStaffImportantMonitorAddMatterAddressActivity extends PetitionStaffBaseActivity implements View.OnClickListener{
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (list.get(position).getChildren().size()==0) {
                    editor.putString(getString(R.string.petition_staff_contact_QY_SH),list.get(position).getMC());
                    editor.putString(getString(R.string.petition_staff_contact_QY_SHDM),list.get(position).getDM());
                    editor.putString(getString(R.string.petition_staff_contact_QY_S),"");
                    editor.putString(getString(R.string.petition_staff_contact_QY_SDM),"");
                    ...
                    editor.commit();
                    PetitionStaffImportantMonitorAddMatterAddressActivity.this.finish();
                } else {
                    Intent intent = new Intent(PetitionStaffImportantMonitorAddMatterAddressActivity.this, PetitionStaffImportantMonitorAddMatterAddressActivity01.class);
