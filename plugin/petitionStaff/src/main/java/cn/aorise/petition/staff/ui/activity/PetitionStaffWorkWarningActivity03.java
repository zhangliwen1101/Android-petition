...
public class PetitionStaffWorkWarningActivity03 extends PetitionStaffBaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (R.id.rl_petition_return==id) {
            PetitionStaffWorkWarningActivity03.this.finish();
    ...
    protected void initView() {
        ...
        mBinding.txtTitle.setText(getString(R.string.petition_staff_work_warning_04));
                ...
                if(keyCode==KeyEvent.KEYCODE_ENTER){//修改回车键功能
                    ...
                    ((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE))
                            .hideSoftInputFromWindow(
                                    PetitionStaffWorkWarningActivity03.this
                                            .getCurrentFocus()
                                            .getWindowToken(),
                            ...
                            public void onNext(APIResult<List<RWorkWarningList>> listAPIResult) {
                                ...
                                mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        Intent intent=new Intent(PetitionStaffWorkWarningActivity03.this,PetitionStaffWorkWarningDetailActivity.class);
