                ...
                .subscribe(Utils.mockSubscriber(this, Mock.PETITION_LOGIN,
                        new TypeToken<APIResult<List<RDMIDMC>>>() {
                            ...
                            public void onNext(APIResult<List<RDMIDMC>> listAPIResult) {
                                ...
                                mAdapter=new ZJLXAdapter(data,PetitionStaffImportantMonitorAddMatterXFMDActivity.this);
                                ...
                                mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        editor.putString(getString(R.string.petition_staff_sp_XFMD),data.get(position).getMC());
                                        editor.putString(getString(R.string.petition_staff_sp_XFMDID),data.get(position).getDM());
                                        editor.commit();
