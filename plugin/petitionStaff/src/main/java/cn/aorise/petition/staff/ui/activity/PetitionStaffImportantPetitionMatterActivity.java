...
public class PetitionStaffImportantPetitionMatterActivity extends PetitionStaffBaseActivity implements View.OnClickListener{
    private PetitionStaffActivityImportantPetitionMatterBinding mBinding;
    ...
    private ImportantPetitionMatterAdapter mAdapter;
    private List<RImportantPetitionMatter> data=new ArrayList<>();
    ...
    public void onClick(View v) {
        ...
        if (R.id.rl_petition_return==id) {
            PetitionStaffImportantPetitionMatterActivity.this.finish();
    ...
    protected void initData() {
        mAdapter=new ImportantPetitionMatterAdapter(data,this);
    ...
    protected void initView() {
        ...
        mBinding= DataBindingUtil.setContentView(this, R.layout.petition_staff_activity_important_petition_matter);
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent=new Intent(PetitionStaffImportantPetitionMatterActivity.this,PetitionStaffImportantPetitionMatterDetailActivity.class);
                intent.putExtra("letterId",data.get(position).getBH());
                ...
                if(keyCode==KeyEvent.KEYCODE_ENTER){//修改回车键功能
                    ...
                    ((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE))
                            .hideSoftInputFromWindow(
                                    PetitionStaffImportantPetitionMatterActivity.this
                                            .getCurrentFocus()
                                            .getWindowToken(),
