...
public class PetitionStaffWorkWarningActivity06 extends PetitionStaffBaseActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (R.id.rl_petition_return==id) {
            PetitionStaffWorkWarningActivity06.this.finish();
                ...
                if(keyCode==KeyEvent.KEYCODE_ENTER){//修改回车键功能
                    ...
                    ((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE))
                            .hideSoftInputFromWindow(
                                    PetitionStaffWorkWarningActivity06.this
                                            .getCurrentFocus()
                                            .getWindowToken(),
                            ...
                            public void onNext(APIResult<List<RWorkWarningList>> listAPIResult) {
                                ...
                                mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                    ...
                                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                        Intent intent=new Intent(PetitionStaffWorkWarningActivity06.this,PetitionStaffWorkWarningDetailActivity.class);
