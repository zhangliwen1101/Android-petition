...
public class PetitionStaffChangePersonalInfoAddress extends PetitionStaffBaseActivity implements View.OnClickListener{
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (list.get(position).getChildren().size()==0) {
                    editor.putString(getString(R.string.petition_staff_QY_SH),list.get(position).getMC());
                    editor.putString(getString(R.string.petition_staff_QY_SHDM),list.get(position).getDM());
                    editor.putString(getString(R.string.petition_staff_QY_S),"");
                    editor.putString(getString(R.string.petition_staff_QY_SDM),"");
                    editor.putString(getString(R.string.petition_staff_QY_X),"");
                    editor.putString(getString(R.string.petition_staff_QY_XDM),"");
                    editor.commit();
                    PetitionStaffChangePersonalInfoAddress.this.finish();
                } else {
                    Intent intent = new Intent(PetitionStaffChangePersonalInfoAddress.this, PetitionStaffChangePersonalInfoAddress01.class);
