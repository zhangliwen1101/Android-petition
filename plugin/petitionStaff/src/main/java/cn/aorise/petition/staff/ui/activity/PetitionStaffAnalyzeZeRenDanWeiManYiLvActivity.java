...
public class PetitionStaffAnalyzeZeRenDanWeiManYiLvActivity extends PetitionStaffBaseActivity implements View.OnClickListener {
    ...
    private String[] st={"总数","满意数","基本满意数","不满意数"};//柱状图

    private String[] x = new String[] { "满意数","基本满意数","不满意数" }; //饼状图
    private Float[] y;
    ...
    protected void initView() {
        ...
        mBinding.txtTitle.setText("责任单位及时受理率");
    ...
    private void GetAnalyze(String dataStart, String dataEnd, String type,String xingshi,String ZeRenDanWei) {
        ...
        Subscription subscription = PetitionStaffApiService.Factory.create().GetZerendanweimanyilv(GsonUtil.toJson(t))
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(Utils.mockSubscriber(this, Mock.PETITION_LOGIN,
                        new TypeToken<APIResult<RAnalyze>>() {
                            ...
                            public void onNext(APIResult<List<Float>> rAnalyzeAPIResult) {
                                ...
                                try {
                                    ...
                                    MpChartAndroidUtil.showBarChart1(PetitionStaffAnalyzeZeRenDanWeiManYiLvActivity.this, mBinding.barchart, barData);
                                } catch (Exception e) {
