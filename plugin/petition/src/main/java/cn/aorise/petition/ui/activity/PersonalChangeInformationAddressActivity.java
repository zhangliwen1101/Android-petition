        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (list.get(position).getChildren().size()==0) {
                    editor.putString(getString(R.string.petition_share_registAddress_QY_SH),list.get(position).getMC());
                    editor.putString(getString(R.string.petition_regist_addaddress_QYSHDM),list.get(position).getDM());
                    editor.putString(getString(R.string.petition_share_registAddress_QY_S),"");
                    editor.putString(getString(R.string.petition_regist_addaddress_QYSDM),"");
                    ...
                    editor.commit();
                    PersonalChangeInformationAddressActivity.this.finish();
                } else {
