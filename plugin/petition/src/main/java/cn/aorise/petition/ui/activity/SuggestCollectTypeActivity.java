        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (list.get(position).getChildren().size()==0) {
                    editor.putString(getString(R.string.petition_suggest_collect_JYLXY),list.get(position).getMC());
                    editor.putString(getString(R.string.petition_suggest_collect_JYLXYDM),list.get(position).getDM());
                    editor.putString(getString(R.string.petition_suggest_collect_JYLXE),"");
                    editor.putString(getString(R.string.petition_suggest_collect_JYLXEDM),"");
                    ...
                    editor.commit();
                    SuggestCollectTypeActivity.this.finish();
                } else {
