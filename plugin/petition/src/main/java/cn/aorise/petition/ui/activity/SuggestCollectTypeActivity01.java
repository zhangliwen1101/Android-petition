        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (data1.size()==0) {
                    for (int i=0;i<list.size();i++) {
                        if (list.get(i).getDM().equals(getIntent().getExtras().getString("DM"))) {
                            editor.putString(getString(R.string.petition_suggest_collect_JYLXY),list.get(i).getMC());
                            editor.putString(getString(R.string.petition_suggest_collect_JYLXYDM),list.get(i).getDM());
                        }
                    }
                    ...
                    editor.putString(getString(R.string.petition_suggest_collect_JYLXS),"");
                    editor.putString(getString(R.string.petition_suggest_collect_JYLXSDM),"");

                    editor.commit();
                    SuggestCollectTypeActivity.instance.finish();
                    SuggestCollectTypeActivity01.this.finish();
                }
                mAdapter1=new AddAddressAdapter(data1,SuggestCollectTypeActivity01.this);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                for (int i=0;i<list1.size();i++) {
                    if (data1.get(position).getFJDM().equals(list1.get(i).getDM())) {
                        editor.putString(getString(R.string.petition_suggest_collect_JYLXE),list1.get(i).getMC());
                        editor.putString(getString(R.string.petition_suggest_collect_JYLXEDM),list1.get(i).getDM());
                    }
                }

                editor.putString(getString(R.string.petition_suggest_collect_JYLXS),data1.get(position).getMC());
                editor.putString(getString(R.string.petition_suggest_collect_JYLXSDM),data1.get(position).getDM().toString());
                editor.commit();
