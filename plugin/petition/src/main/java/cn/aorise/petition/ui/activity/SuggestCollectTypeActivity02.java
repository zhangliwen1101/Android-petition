...
public class SuggestCollectTypeActivity02 extends PetitionBaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                editor.putString(getString(R.string.petition_suggest_collect_JYLXS),data.get(position).getMC());
                editor.putString(getString(R.string.petition_suggest_collect_JYLXSDM),data.get(position).getDM().toString());
                editor.commit();
                SuggestCollectTypeActivity.instance.finish();
                SuggestCollectTypeActivity01.instance.finish();
                SuggestCollectTypeActivity02.this.finish();
