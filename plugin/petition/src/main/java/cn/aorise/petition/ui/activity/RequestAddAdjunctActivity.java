...
public class RequestAddAdjunctActivity extends PetitionBaseActivity implements View.OnClickListener {
                ...
                if (picturePath.size()==0){
                    ...
                    if (i==picturePath.size()&&picturePath.size()<=4){
                        ...
                        if( file != null && file.isFile() == true){
                            new AlertDialog.Builder(RequestAddAdjunctActivity.this).setTitle("系统提示")//设置对话框标题
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                new AlertDialog.Builder(RequestAddAdjunctActivity.this).setTitle("系统提示")//设置对话框标题
                        ...
                        .setPositiveButton("预览",new DialogInterface.OnClickListener() {//添加确定按钮
                            ...
                            public void onClick(DialogInterface dialog, int which) {//确定按钮的响应事件
                                // TODO Auto-generated method stub
                                FileUtils.openFile(RequestAddAdjunctActivity.this,new File(filePath.get(position)));
                            }
    ...
    private void getPermisson(){
        if (ActivityCompat.checkSelfPermission(RequestAddAdjunctActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions((BaseActivity) RequestAddAdjunctActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
        }
    }
}
