...
public class RequestAddQuestActivity02 extends PetitionBaseActivity implements View.OnClickListener {
    ...
    private String DM;
    private RequestAddQuestActivity RA;
    private RequestAddQuestActivity01 RA1;
    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                editor.putString(getString(R.string.petition_sharepre_LXS),data.get(position).getMC());
                editor.putString(getString(R.string.petition_shareprefer_LXSDM),data.get(position).getDM().toString());
                editor.commit();
                RequestAddQuestActivity.instance.finish();
                RequestAddQuestActivity01.instance.finish();
                RequestAddQuestActivity02.this.finish();
