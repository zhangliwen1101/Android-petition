...
public class RegistAddressActivity02 extends PetitionBaseActivity implements View.OnClickListener{
    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                editor.commit();
                RegistAddressActivity.instance.finish();
                RegistAddressActivity01.instance.finish();
                RegistAddressActivity02.this.finish();
            }
        });
    }
