        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (list.get(position).getChildren().size()==0) {
                    editor.putString(getString(R.string.petition_sharepre_LXY),list.get(position).getMC());
                    editor.putString(getString(R.string.petition_sharepre_LXYDM),list.get(position).getDM());
                    editor.putString(getString(R.string.petition_sharepre_LXE),"");
                    editor.putString(getString(R.string.petition_shareprefer_LXEDM),"");
                    editor.putString(getString(R.string.petition_sharepre_LXS),"");
                    editor.putString(getString(R.string.petition_shareprefer_LXSDM),"");
                    editor.commit();
                    RequestAddQuestActivity.this.finish();
                } else {
