        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (list.get(position).getChildren().size()==0) {
                    editor.putString(getString(R.string.petition_shareprefers_contact_people_SH),list.get(position).getMC());
                    editor.putString(getString(R.string.petition_shareprefers_contact_people_SHDM),list.get(position).getDM());
                    editor.putString(getString(R.string.petition_shareprefers_contact_people_S),"");
                    editor.putString(getString(R.string.petition_shareprefers_contact_people_SDM),"");
                    ...
                    editor.commit();
                    RequestAddContactPeopleAddress.this.finish();
                } else {
