...
public class PersonalChangeInformationAddressActivity02 extends PetitionBaseActivity implements View.OnClickListener{
    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                editor.putString(getString(R.string.petition_share_registAddress_QY_X),data.get(position).getMC());
                editor.putString(getString(R.string.petition_regist_addaddress_QYXDM),data.get(position).getDM().toString());
                editor.commit();
                PersonalChangeInformationAddressActivity.instance.finish();
                PersonalChangeInformationAddressActivity01.instance.finish();
                PersonalChangeInformationAddressActivity02.this.finish();
            }
        });
    }
