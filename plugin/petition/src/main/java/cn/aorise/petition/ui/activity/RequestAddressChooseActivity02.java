...
public class RequestAddressChooseActivity02 extends PetitionBaseActivity implements View.OnClickListener{
    ...
    protected void initView() {
        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                editor.putString(getString(R.string.petition_sharepre_SFD_X),data.get(position).getMC());
                editor.putString(getString(R.string.petition_sharepre_SFD_XDM),data.get(position).getDM().toString());
                editor.commit();
                RequestAddressChooseActivity.instance.finish();
                RequestAddressChooseActivity01.instance.finish();
                RequestAddressChooseActivity02.this.finish();
            }
        });
    }
