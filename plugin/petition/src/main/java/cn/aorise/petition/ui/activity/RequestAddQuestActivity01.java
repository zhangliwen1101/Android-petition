        ...
        mBinding.listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (data1.size()==0) {
                    for (int i=0;i<list.size();i++) {
                        if (list.get(i).getDM().equals(getIntent().getExtras().getString("DM"))) {
                            editor.putString(getString(R.string.petition_sharepre_LXY),list.get(i).getMC());
                            editor.putString(getString(R.string.petition_sharepre_LXYDM),list.get(i).getDM());
                        }
                    }
                    ...
                    editor.putString(getString(R.string.petition_sharepre_LXS),"");
                    editor.putString(getString(R.string.petition_shareprefer_LXSDM),"");

                    editor.commit();
                    RequestAddQuestActivity.instance.finish();
                    RequestAddQuestActivity01.this.finish();
                }
                mAdapter1=new AddAddressAdapter(data1,RequestAddQuestActivity01.this);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                for (int i=0;i<list1.size();i++) {
                    if (data1.get(position).getFJDM().equals(list1.get(i).getDM())) {
                        editor.putString(getString(R.string.petition_sharepre_LXE),list1.get(i).getMC());
                        editor.putString(getString(R.string.petition_shareprefer_LXEDM),list1.get(i).getDM());
                    }
                }

                editor.putString(getString(R.string.petition_sharepre_LXS),data1.get(position).getMC());
                editor.putString(getString(R.string.petition_shareprefer_LXSDM),data1.get(position).getDM().toString());
                editor.commit();
